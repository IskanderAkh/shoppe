...
const ShopMenu = () => {
    return (
        <div className='absolute z-30 -left-72 shopmenu transition'>
            <ul className="menu sm:menu-horizontal bg-white border-gray-300 border md:min-w-max menuShop gap-10 pr-10">
                <li className='p-4'>
                    <ul className='before:opacity-0 pl-0'>
                        ...
                        <li><Link to={'/shop'} className='text-gray-500 hover:text-black transition'>Shop full width</Link></li>
                        <li><Link to={'/shop'} className='text-gray-500 hover:text-black transition'>Shop With sidebar</Link></li>
                        <li><Link to={'/shop'} className='text-gray-500 hover:text-black transition'>Shop category</Link></li>
                        <li><Link to={'/shop-carousel'} className='text-gray-500 hover:text-black transition'>Shop carousel</Link></li>
